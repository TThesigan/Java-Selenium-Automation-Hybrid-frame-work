...
public class ExtentReportManager implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		extent.setSystemInfo("Application", "mycart");
	...
	public void onFinish(ITestContext testContext) {
		 ...
		 * DefaultAuthenticator("sender@gmail.com","password"));
		 * email.setSSLOnConnect(true); email.setFrom("sender@gmail.com"); //Sender
		 * email.setSubject("Test Results");
		 * email.setMsg("Please find Attached Report....");
		 * email.addTo("receiver@gmail.com"); //Receiver email.attach(url,
